...
SystemChatBot = [
    ...
    {"role": "assistant", "content": f"Hello,  {Username}, how can I assist you today? I am {Assistantname}, your AI assistant with real-time information capabilities."}
]
...
def Information():
    ...
    data = f"Current Date: {day}, {date} {month} {year}\n"
...
if __name__ == "__main__":
    while True:
        ...
        print(RealtimeInformation(query))